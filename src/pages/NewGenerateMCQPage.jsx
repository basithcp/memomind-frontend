...
const NewGenerateMCQPage = () => {
  ...
  return (
    <div className="container-fluid" style={{ paddingBottom: 96 /* room for prompt bar */ }}>
      ...
      <ChatPromptBar
        onSend={(prompt) => {
          // Basic placeholder handling — keep minimal per your instruction.
          console.log('Prompt sent from MCQ page:', prompt)
        }}
      />
    </div>
  )
...
export default NewGenerateMCQPage
